...
<SCRIPT language=javascript>
   $(document).ready(function(){
      var i=15;
     var firstSize= $("#first").val();
     var lastSize=  $("#last").val();
      if(i==firstSize){
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												<select name="pageSize" id="pageSize1">
												
												<option value="15" id="first">15</option>
												<option value="30" id="last">30</option>
												</select>

												条 [<A href="javascript:to_page(${page-1})">前一页</A>] <B>${page}</B>
